...
func (s *Store) CreateUser(user types.User) error {
	_, err := s.db.Exec(context.Background(), "INSERT INTO users (firstName, lastName, email, password) VALUES ($1, $2, $3, $4)", user.FirstName, user.LastName, user.Email, user.Password)
	if err != nil {
		return err
	}
